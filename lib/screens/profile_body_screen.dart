              ...
              children: [
                Row(
                  children: [
                    ...
                    const Spacer(),
                    Text('065120123', style: vkTextCardBold),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Text('Andini Delia Pratami', style: vkTextLightGrey),
              ],
            ),
          ),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Text('Andini', style: vkTextLightGrey),
              ],
            ),
          ),
          const Divider(color: Color(0xffee8301)),
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Kp. Komplek Pasir Dalem, RT/RW 04/01, Kec.Cidahu, Kab.Sukabumi, Jawa Barat',
